function [Macroscopic_Cross_Sections, Surface_Sources] = CrossSection(CrossSection_Source)

if CrossSection_Source == 'HW'
...
Function = {'@(Omega_z)1'; '@(Omega_z)1+Omega_z'; '@(Omega_z)dirac(Omega_z-1)'}; % str2func(char(Surface_Sources{'Isotropic','Function'}))
Range_Omega_z = {'>0'; 'None'; 'None'};

Surface_Sources = table(Range_Omega_z, Function, 'RowNames', Source);
else
